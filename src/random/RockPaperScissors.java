...
public class RockPaperScissors extends JPanel implements ActionListener{
    ...
    public void run(){
		...
		try {
			...
			rockImage = new ImageIcon(getClass().getResource("BOCK.jpg"));
			paperImage = new ImageIcon(getClass().getResource("NAPER.jpeg"));
			scissorsImage = new ImageIcon(getClass().getResource("DCISSORS.jpg"));
    ...
    public void actionPerformed(ActionEvent e) {
    	...
    	int opponentSelection = boi.nextInt(3);
